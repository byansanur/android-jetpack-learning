...
object DataDummy {
    ...
    fun generateDataTvShow() : List<TvShowEntity> {
        ...
        tvShowEntity.add(TvShowEntity(
            ...
            "https://www.themoviedb.org/tv/62286-fear-the-walking-dead"
        ))
        tvShowEntity.add(TvShowEntity(
            "tv2",
            "The Walking Dead",
        ...
        tvShowEntity.add(TvShowEntity(
            ...
            "https://www.themoviedb.org/tv/82596-emily-in-paris"
        ))
        tvShowEntity.add(TvShowEntity(
            "tv4",
            "Riverdale",
        ...
        tvShowEntity.add(TvShowEntity(
            ...
            "https://www.themoviedb.org/tv/63174-lucifer"
        ))
        tvShowEntity.add(TvShowEntity(
            "tv6",
            "The Boys",
        ...
        tvShowEntity.add(TvShowEntity(
            ...
            "https://www.themoviedb.org/tv/94305-the-walking-dead-world-beyond"
        ))
        tvShowEntity.add(TvShowEntity(
            "tv8",
            "The 100",
            ...
            "https://www.themoviedb.org/tv/48866-the-100"
        ))
        tvShowEntity.add(TvShowEntity(
            "tv9",
            "The Vampire Diaries",
            ...
            "https://www.themoviedb.org/tv/18165-the-vampire-diaries"
        ))
        tvShowEntity.add(TvShowEntity(
            "tv10",
