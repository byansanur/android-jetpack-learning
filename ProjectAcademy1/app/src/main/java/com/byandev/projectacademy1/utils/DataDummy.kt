...
object DataDummy {
    fun generateDummyCourse() : List<CourseEntity> {
        val courseEntity = ArrayList<CourseEntity>()

        courseEntity.add(CourseEntity("a14",
        ...
        courseEntity.add(CourseEntity("a55",
        ...
        courseEntity.add(CourseEntity("a47",
        ...
        courseEntity.add(CourseEntity("a74",
        ...
        courseEntity.add(CourseEntity("a51",
    ...
    fun generateDummyModules(courseId: String) : List<ModuleEntity> {
        val moduleEntity = ArrayList<ModuleEntity>()

        moduleEntity.add(ModuleEntity(
            "{$courseId}m1",
            courseId,
            "Modul 0 : Introduction",
            0))
        moduleEntity.add(ModuleEntity("{$courseId}m2",
            courseId,
            "Modul 1 : Teori 1",
            1, false))
        moduleEntity.add(ModuleEntity("{$courseId}m3",
            courseId,
            "Latihan 1",
            2, false))
        moduleEntity.add(ModuleEntity("{$courseId}m4",
            courseId,
            "Bedah Kode 1",
            3, false))
        moduleEntity.add(ModuleEntity("{$courseId}m5",
            courseId,
            "Modul 2 : Teori 2",
            4, false))

        moduleEntity.add(ModuleEntity("{$courseId}m6",
            courseId,
            "Latihan 2",
            5, false))

        moduleEntity.add(ModuleEntity("{$courseId}m7",
            courseId,
            "Bedah Kode 2",
            6, false))
