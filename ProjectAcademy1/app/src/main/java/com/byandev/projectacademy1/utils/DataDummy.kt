...
object DataDummy {
    fun generateDummyCourse() : ArrayList<CourseEntity> {
    ...
    // for fake remote
    fun generateRemoteDummyCourse() : List<CourseResponse> {
    ...
    fun generateRemoteDummyModules(courseId: String): List<ModuleResponse> {
        ...
        modules.add(ModuleResponse(
            ...
            "Modul 0 : Introduction",
            0))
        modules.add(ModuleResponse("{$courseId}m2",
            courseId,
            "Modul 1 : Teori 1",
            1))
        modules.add(ModuleResponse("{$courseId}m3",
            courseId,
            "Latihan 1",
            2))
        modules.add(ModuleResponse("{$courseId}m4",
            courseId,
            "Bedah Kode 1",
            3))
        modules.add(ModuleResponse("{$courseId}m5",
            courseId,
            "Modul 2 : Teori 2",
            4))
        modules.add(ModuleResponse("{$courseId}m6",
            courseId,
            "Latihan 2",
            5))
        modules.add(ModuleResponse("{$courseId}m7",
            courseId,
            "Bedah Kode 2",
            6))
        return modules
